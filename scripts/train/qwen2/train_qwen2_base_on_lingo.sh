FINETUNE_DATA_PATH=playground/data/LingoQA/train_multi.json #finetune annotation file path
FINETUNE_IMAGE_PATH=""
LLM_VERSION=/mnt/csi-data-aly/user/haozhou/Projects/TinyLLaVA_Factory/checkpoints/Qwen/Qwen2.5-3B # llm path in huggingface
...
VERSION=qwen2.5-3b_base #experiment name for recording different runnings
